...
class SVMR(Model):
    """
	A subclass of the Model metaclass used to represent a SVMR model.

	.. py:meth:: SVMR.run_gridsearch()
	.. py:meth:: SVMR.train()
    ...
    def run_gridsearch(self, cv, cv_score: str) -> None:
        ...
        model = svm.SVR(**self.fixed_params)
    ...
    def train(self, use_gridsearch_results: bool = True) -> None:
        ...
        self.best_model = svm.SVR(**params)
...
class NB(Model):
    ...
    def run_gridsearch(self, cv, cv_score: str) -> None:
        ...
        model = GaussianNB(**self.fixed_params)
    ...
    def train(self, use_gridsearch_results: bool = True) -> None:
        ...
        self.best_model = GaussianNB(**params)
